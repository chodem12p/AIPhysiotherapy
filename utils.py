...
def base2cv(str1):
  ...
  return pil_to_opencv(input_img)
def opencv2jpeg(buff):
  pil2=opencv_to_pil(buff)
  str2=str(pil_image_to_base64(pil2)).split("'")[1]
  return str("data:image/jpeg;base64,"+str2)
